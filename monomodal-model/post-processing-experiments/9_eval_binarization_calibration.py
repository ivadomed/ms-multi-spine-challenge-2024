...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate the performance of the calibration of the model.")
    parser.add_argument('--image_dict', type=str, required=True, help='Path to the JSON file containing image metadata.')
    parser.add_argument('--input_folder', type=str, required=True, help='Path to the folder containing predictions.')
