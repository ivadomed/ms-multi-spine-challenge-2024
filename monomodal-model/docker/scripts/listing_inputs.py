...
def find_pattern(pattern: str, path: str, followlinks: bool = False):
...
def listing_input_files(path: str):
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input_folder', required=False, default= './root_folder', help="Path to the input folder.")
