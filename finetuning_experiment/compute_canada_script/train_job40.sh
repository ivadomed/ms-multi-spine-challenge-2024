...
plans="nnUNetResEncUNetLPlansFinetuneRawSpace"
trainer="nnUNetTrainerDAExt_DiceCELoss_noSmooth_500epochs_fromScratch"
model_checkpoint="checkpoint_final.pth"

# Model training:
echo ""
echo "Training the model"
CUDA_VISIBLE_DEVICES=$cuda_device nnUNetv2_train  $dataset_number  $configurations $fold -p $plans -tr $trainer