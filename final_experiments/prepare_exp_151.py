"""
In this script, we prepare the experiment 151 by creating folders for each subject with the necessary files for evaluation. This way, we aim at increase the speed of testing. 
